...
namespace mip
{
    ...
    public:
        ...
        template<bool (*Send)(Interface&, microstrain::ConstU8ArrayView)>
        void setSendFunctionFree();

        template<bool (*Recv)(Interface&, uint8_t*, size_t, Timeout, bool, size_t*, Timestamp*)>
        void setRecvFunctionFree();
        template<bool (*Recv)(Interface&, microstrain::U8ArrayView, Timeout, bool, size_t*, Timestamp*)>
        void setRecvFunctionFree();
        ...
        template<class UserClass, bool (UserClass::*Send)(microstrain::ConstU8ArrayView)>
        void setSendFunctionUserPointer();
        template<class UserClass, bool (*Send)(UserClass*, microstrain::ConstU8ArrayView)>
        void setSendFunctionUserPointer();

        template<class UserClass, bool (UserClass::*Recv)(uint8_t*, size_t, Timeout, bool, size_t*, Timestamp*)>
        void setRecvFunctionUserPointer();
        template<class UserClass, bool (UserClass::*Recv)(microstrain::U8ArrayView, Timeout, bool, size_t*, Timestamp*)>
        void setRecvFunctionUserPointer();
        template<class UserClass, bool (*Recv)(UserClass*, microstrain::U8ArrayView, Timeout, bool, size_t*, Timestamp*)>
        void setRecvFunctionUserPointer();
        ...
        template<
            class T,
            bool (T::*Send)(microstrain::ConstU8ArrayView),
            bool (T::*Recv)(microstrain::U8ArrayView, Timeout, bool, size_t*, Timestamp*),
        ...
        template<class Derived, bool (Derived::*Send)(microstrain::ConstU8ArrayView)>
        void setSendFunctionDerived();

        template<class Derived, bool (Derived::*Recv)(microstrain::U8ArrayView, Timeout, bool, size_t*, Timestamp*)>
        ...
        template<
            ...
            bool (Derived::*Recv)(microstrain::U8ArrayView, Timeout, bool, size_t*, Timestamp*),
        ...
        bool defaultUpdateExtBuffer(Timeout wait_time, bool from_cmd, microstrain::U8ArrayView buffer) { return C::mip_interface_default_update_ext_buffer(this, wait_time, from_cmd, buffer.data(), buffer.size()); }
        ...
        void inputBytes(microstrain::ConstU8ArrayView data, Timestamp timestamp) { C::mip_interface_input_bytes_from_device(this, data.data(), data.size(), timestamp); }
        ...
        void inputBytesAndOrTime(microstrain::ConstU8ArrayView data, Timestamp timestamp) { C::mip_interface_input_bytes_andor_time(this, data.data(), data.size(), timestamp); }
    ...
    /// {
    ///     bool sendToDevice(const uint8_t* data, size_t size);
    ///     bool recvFromDevice(microstrain::ConstU8ArrayView, Timeout wait_time, size_t* length_out, Timestamp* timestamp_out);
    /// };
    ///
    /// MyClass instance;
    ///
    ...
    /// bool recvFromDevice(MyClass* mc, microstrain::ConstU8ArrayView, Timeout wait_time, size_t* length_out, Timestamp* timestamp_out);
    ///
    /// MyClass instance;
    ///
    /// instance.setUserPointer(&instance);
    ...
    template<
        ...
        bool (UserClass::*Recv)(microstrain::U8ArrayView, Timeout, bool, size_t*, Timestamp*),
    ...
    /// {
    ///     bool send(microstrain::ConstU8ArrayView);
    ///     bool recv(microstrain::U8ArrayView, Timeout wait_time, size_t* length_out, Timestamp* timestamp_out);
    /// };
    ///
    /// DeviceConnection connection;
    /// mip::Interface interface;
    ...
    CmdResult runCommand(C::mip_interface& device, const Cmd& cmd, typename Cmd::Response& response, Timeout additionalTime)
    {
        ...
        C::mip_pending_cmd pending;
        C::mip_pending_cmd_init_full(&pending, Cmd::DESCRIPTOR_SET, Cmd::FIELD_DESCRIPTOR, Cmd::Response::FIELD_DESCRIPTOR, packet.buffer_w().data(), FieldView::PAYLOAD_LENGTH_MAX, additionalTime);
